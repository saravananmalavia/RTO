...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css">
  ...
  <script src="../validation/temp_request_validation.js"></script>
<style>
  .badge
   {
  border-radius: 50%;
...
%>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="temp_request_process.jsp" onsubmit="return validate()" name="form3">
				...
				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Customer Address">
					...
					<textarea class="input100" type="text" name="txtCaddress" id="txtCaddress" placeholder="Customer Address here..." ></textarea>
					<span><p id="id5"></p>
				</div>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					...
					<input class="input100" type="number" name="txtSeat" id="txtSeat" placeholder="Enter Seating Capacity" maxvalue="99">
					<span><p id="id9"></p>
				</div>
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					...
					<input class="input100" type="text" name="txtAmount" id="txtAmount" placeholder="Enter Sale Amount">
					<span><p id="id11"></p>
				</div>
